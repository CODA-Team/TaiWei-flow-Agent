...
- **OpenAI API Key**:
- You need to create an `api.sh` file and add the API key for the large language model to export environment variables with the format in `optimize.py`.
